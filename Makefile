...
BONUS =	bonus/check_stack.c bonus/checker.c bonus/ft_split.c bonus/get_next_line.c bonus/list_moves.c bonus/list.c bonus/moves.c bonus/utilities.c  bonus/get_utilities.c bonus/user_do.c
SRC_OBJ = $(SRC:.c=.o)
